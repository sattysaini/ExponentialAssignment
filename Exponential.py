import numpy as np
from kera.layers import Input, Dense
...
def exp():
	...
	layer2 = Dense(1024, actication = "relu", kernel_initializer = "random_uniform")(Layer1)
